...
public class FontAwesomeDrawable extends Drawable {
    ...
    public FontAwesomeDrawable(int icon, int sizeDpi, int color,
    ...
    public static class FontAwesomeDrawableBuilder {
        ...
        public FontAwesomeDrawableBuilder(Context context) {
            this.context = context;
        }
